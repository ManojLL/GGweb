...
import giraffe from '../../images/giraffe_throne.png';
  ...
  return (
    <div>
      ...
      <section className="hero is-fullheight">
        ...
        <div className="hero-body landing">
            ...
            <div className="columns is-vcentered">
              <div className="colum is-half p-6">
                <div className="container py-6">
                  ...
                  <Fade bottom>
                    <p className="">Goofy Giraffes are a set of animals that mutated to have human-like 
